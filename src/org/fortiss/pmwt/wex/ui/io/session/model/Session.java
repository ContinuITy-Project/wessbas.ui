...
public class Session
{
	...
	public void addState( State state )
	{
		...
		this.m_lFirstTimestamp = Math.min( this.m_lFirstTimestamp, state.getTimeIn().longValue() );
		this.m_lLastTimestamp = Math.max( this.m_lLastTimestamp, state.getTimeOut().longValue() );
	}
