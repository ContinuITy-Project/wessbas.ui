...
public class NumberUtils
{
	 ...
	 * @return Instance of Integer that represents the string value or the provided default value on error.
	 */
	 ...
	 * @param lDefaultValue
	 *            Default value if conversion fails.
	 * @return Instance of Long that represents the string value or the provided default value on error.
	 */
	 ...
	 * @return String value that represents the integer value or the default value on error.
	 */
