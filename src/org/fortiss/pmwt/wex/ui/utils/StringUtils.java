...
{
	/**
	 * Converts a Long to its string representation, or if null, to an empty string.
	 * 
	 * @param lValue
	 *            Long value to be converted to a string.
	 * @return String representation of the long value, or if null, an empty string.
	 */
	...
	public static boolean equals( String str0, String str1 )
	{
		...
		else if( ( str0 == null && str1 != null ) || ( str0 != null && str1 == null ) )
		{
			return false;
		}
		else
	 ...
	 *            Default string value if integer cannot be converted (e.g., null).
	 ...
	 * @return An empty string if strValue is null, string-value of strValue otherwise.
	 */
